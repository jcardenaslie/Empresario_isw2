            ...
            <div class="col-md-3">
                <p class="lead">Lugares</p>
                    ...
                    <?php while($resultado1=mysqli_fetch_array($proc1,MYSQL_ASSOC)){ ?>
                          ...
                          <?php if ($contador>1){ ?>
                            <a  class="list-group-item lugar<?php echo $contador; ?>" href="#"><?php echo strtoupper($resultado1['nombre']);  ?></a>
                          <?php } ?>
                    <?php $contador++; } ?>
...
<!-- taggsssssssssssssssssss-->
                    ...
                    <div class="caption-full">
                     ...
                     <div class="item-content-block tags">
                      ...
                      <?php 
                      $lug=$resultado2['id_lugar'];
                      $nq="SELECT categoria FROM posee WHERE id_lugar='$lug'";
                    $pr = mysqli_query($mysqli,$nq);
                    
                    
                    while($resultado3 = mysqli_fetch_array($pr,MYSQL_ASSOC)){?>
                      <p><?php echo strtoupper($resultado3['categoria']);?></p>
                      <?php } ?> 
                    </div>
<!-- taggsssssssssssssssssss-->
                        ...
                        <form action="edit_lugar.php" method="POST">
                        <input type="hidden" name="chupalo" value="<?php echo $resultado2['id_lugar']; ?>">
                        <input type="submit"  name="edtlg"  value="Editar" class="btn btn-success" >
                        </form>
